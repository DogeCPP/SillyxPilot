...
The xPilot plugin that yells at you when a supervisor slides into your DMs.So short story, 
...
and that was that. So I built the thing I wish I had that day: a little plugin that watches my 
messages and absolutely refuses to let me miss the important ones. 
If a supervisor contacts me, my whole desk lights up. Loud sound, popup, Discord ping. 
There is no sleeping through it. --> **You need xpilot v4.0 to get it work** <--
...
itself when xPilot starts. Leave the tab open so the sounds can reach you. Or if it doesnt,
Click the localhost:3000 on the chatbox.

## Installing

You need xPilot 4.0 or newer. Then:
...
Then the Outputs lands in `SillyxPilot.Plugin/bin/Release/net8.0/`, laid out exactly
...
* The [VAT-Spy Data Project](https://github.com/vatsimnetwork/vatspy-data-project)
* [Leaflet](https://leafletjs.com) for the map.

Not affiliated with VATSIM or the xPilot project. It never touches the network
connection itself, it only listens to what xPilot already tells plugins. Remember,
Stay reachable. Answer your supervisors. And if you cannot be at your kyboard every
second of a long haul, at least have something loud enough to Wake you up.

Fly silly, land safe. -DogeCPP 🐶🛫
